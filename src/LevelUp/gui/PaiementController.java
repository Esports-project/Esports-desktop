...
//                this.prix.setText(String.valueOf(CommandeFrontController.prix));
        valider.setOnAction((ActionEvent event) -> {
            ...
            try {
                ...
                Stripe.apiKey="sk_test_51KasjyJSpqjfwWmRrkqIW5olAB45Gx0z4U9eJPM8JY01WIVmxx4VzjNnDvhRwOE12jHBy3H2aVSiHiNZ9Eazycq300BCLutCXy";
                System.out.println("API");
                Customer a =Customer.retrieve("cus_Lb1DdPuspN1Bhy");
